...
## I. Pipes y su rol en el panorama IPC
...
Código de ejemplo disponible en https://github.com/pablomederos/dotnet-anonymous-pipes
...
Al igual que con los pipes anónimos, paso a listar algunos posibles casos de uso para los pipes nombrados, pero solo pretendo echar algo de luz que pueda llevar al lector a encontrar sus propios casos de uso, quizá, más apropiados o variados.
  ...
  - **Servicios Locais**: Un uso posiblemente útil es enviar comandos a un servicio de larga duración y monitorear el estado. Dicho servicio podría exponer el servidor para que varios otros procesos puedan conectarse y encolar tareas, a la vez que puede enviar notificaciones del estado de las tareas en curso.
...
## VI. Integración con Frameworks Avanzados
...
### A. Pipes como transporte de Alto Rendimiento
...
<div id="texto-ancla15"/>
  ...
  - #### 1. ASP.NET Core con Pipes Nombrados
...
<div id="texto-ancla16"/>
  ...
  - #### 2. RPC tipado con StreamJsonRpc
...
## VII. Pipes frente a Otros Mecanismos de IPC en.NET
