...
**Ventajas con Proyectos Separados (usando Minimal APIs):**
  ...
  - **Alineación Filosófica con VSA:** Invita a la implementación de endpoints pequeños y cohesivos.
  - **Flexibilidad en el Descubrimiento:** Se adapta a las necesidades.
...
Todo lo mencionado anteriormente se condensó (razonablemente) en el repositorio de Github [Vertical Slices en .NET - Github](https://github.com/pablomederos/vetical-slices-dotnet)