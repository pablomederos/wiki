...
La Arquitectura de Corte Vertical (VSA) ha ganado un lugar importante dentro de la comunidad de desarrollo de .NET como una alternativa a los enfoques de arquitectura en capas más tradicionales. Su filosofía central se basa en organizar la lógica de la aplicación en torno a 'features' o características de negocio, a las cuales se les llama "slices" (rebanadas), en lugar de agrupar el código por afinidad técnica en capas horizontales como presentación, lógica de negocio y acceso a datos. Cada slice vertical encapsula todos lo que se requiera para implementar una característica específica. Desde la presentación hasta la persistencia, atravesando todos los requisitos de dominio/negocio relevantes para esa funcionalidad particular.
