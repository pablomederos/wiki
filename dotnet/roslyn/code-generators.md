...
# Roslyn Source Generators
  ...
  * [Generación incremental: Fundamento y aplicación](generaci%C3%B3n-incremental-fundamento-y-aplicaci%C3%B3n)
      * [Ventajas fundamentales de la generación de código en tiempo de compilación](ventajas-fundamentales-de-la-generaci%C3%B3n-de-c%C3%B3digo-en-tiempo-de-compilaci%C3%B3n)
      * [1.2 Casos de uso en el ecosistema .NET](12-casos-de-uso-en-el-ecosistema-net)
      * [1.3 Consideraciones de portabilidad](13-consideraciones-de-portabilidad)
      * [Evolución de `ISourceGenerator` hacia `IIncrementalGenerator`](evoluci%C3%B3n-de-isourcegenerator-hacia-iincrementalgenerator)
      * [Elementos de un Generador de Código](elementos-de-un-generador-de-c%C3%B3digo)
      * [Estrategias para Identificar los Objetivos de Generación](estrategias-para-identificar-los-objetivos-de-generaci%C3%B3n)
      * [Implementación práctica](implementaci%C3%B3n-pr%C3%A1ctica)
      * [Testeando el generador de código](testeando-el-generador-de-c%C3%B3digo)
      * [El rendimiento que ofrece la caché](el-rendimiento-que-ofrece-la-cach%C3%A9)
  * [Conclusión y Recomendaciones Finales](conclusi%C3%B3n-y-recomendaciones-finales)
...
2.  **Definición del Pipeline**: Dentro del método Initialize, se construye el pipeline paso a paso.
  ...
  - Paso 1: **Generar una interfaz marcadora**.
    ...
      ` csharp     public const string MarkerNamespace = "SourceGeneratorExample";     public const string MarkerInterfaceName = "IRepository";     public const string MarkerFullyQualifiedName = $"{MarkerNamespace}.{MarkerInterfaceName}";     private const string Source =            $$"""             // <auto-generated/>             namespace {{MarkerNamespace}} {                 public interface {{MarkerInterfaceName}} { }             }             """;          public void Initialize(IncrementalGeneratorInitializationContext context)     {         context.RegisterPostInitializationOutput(ctx =>              ctx.AddSource(                 $"{MarkerFullyQualifiedName}.g.cs",                 SourceText.From(Source, Encoding.UTF8))             );         ...     }       `
