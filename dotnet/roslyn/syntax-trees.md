...
Si bien este documento ha cubierto los aspectos fundamentales de la creación de clases, métodos y sentencias comunes, existen áreas más avanzadas para una exploración posterior:
...
Fuentes citadas
1. docs/docs/csharp/roslyn-sdk/work-with-syntax.md at main · dotnet/docs - GitHub, https://github.com/dotnet/docs/blob/main/docs/csharp/roslyn-sdk/work-with-syntax.md 2. Get started with syntax analysis (Roslyn APIs) - C# | Microsoft Learn, https://learn.microsoft.com/en-us/dotnet/csharp/roslyn-sdk/get-started/syntax-analysis 3. Proposal: SyntaxNode.ToFullStringWithNormalizedWhitespaces API ..., https://github.com/dotnet/roslyn/issues/52914 4. `SyntaxFactory`Class (Microsoft.CodeAnalysis.CSharp), https://learn.microsoft.com/en-us/dotnet/api/microsoft.codeanalysis.csharp.syntaxfactory?view=roslyn-dotnet-4.13.0 5. Get started with syntax transformation (Roslyn APIs) - C# | Microsoft Learn, https://learn.microsoft.com/en-us/dotnet/csharp/roslyn-sdk/get-started/syntax-transformation 6. roslyn/docs/wiki/Getting-Started-C#-Syntax-Transformation.md at main - GitHub, https://github.com/dotnet/roslyn/blob/main/docs/wiki/Getting-Started-C%23-Syntax-Transformation.md 7. SyntaxFactory.ClassDeclaration Method (Microsoft.CodeAnalysis ..., https://learn.microsoft.com/en-us/dotnet/api/microsoft.codeanalysis.csharp.syntaxfactory.classdeclaration?view=roslyn-dotnet-4.13.0 8. SyntaxFactory.MethodDeclaration Method (Microsoft.CodeAnalysis.CSharp), https://learn.microsoft.com/en-us/dotnet/api/microsoft.codeanalysis.csharp.syntaxfactory.methoddeclaration?view=roslyn-dotnet-4.7.0 9. SyntaxFactory.MethodDeclaration Method (Microsoft.CodeAnalysis ..., https://learn.microsoft.com/en-us/dotnet/api/microsoft.codeanalysis.csharp.syntaxfactory.methoddeclaration 10. How to add parameters to generated method in Roslyn ( Microsoft.CodeAnalysis )? - Need exact syntax - Stack Overflow, https://stackoverflow.com/questions/29787851/how-to-add-parameters-to-generated-method-in-roslyn-microsoft-codeanalysis 11. c# - Add a parameter to a method with a Roslyn CodeFixProvider ..., https://stackoverflow.com/questions/36948218/add-a-parameter-to-a-method-with-a-roslyn-codefixprovider 12. SyntaxFactory.Block Method (Microsoft.CodeAnalysis.CSharp), https://learn.microsoft.com/en-us/dotnet/api/microsoft.codeanalysis.csharp.syntaxfactory.block?view=roslyn-dotnet-4.13.0 13. Roslyn - Creating an introduce and initialize field refactoring - trydis, https://trydis.github.io/2015/01/03/roslyn-code-refactoring/ 14. c# - Modifying body of method with Roslyn - Stack Overflow, https://stackoverflow.com/questions/45102656/modifying-body-of-method-with-roslyn 15. SyntaxFactory.Literal Method (Microsoft.CodeAnalysis.CSharp), https://learn.microsoft.com/en-us/dotnet/api/microsoft.codeanalysis.csharp.syntaxfactory.literal?view=roslyn-dotnet-4.9.0 16. SyntaxFactory.InvocationExpression Method (Microsoft ..., https://learn.microsoft.com/en-us/dotnet/api/microsoft.codeanalysis.csharp.syntaxfactory.invocationexpression?view=roslyn-dotnet-4.13.0 17. Creating Code Using the Syntax Factory - John Koerner, https://johnkoerner.com/csharp/creating-code-using-the-syntax-factory/ 18. SyntaxFactory.ReturnStatement Method (Microsoft.CodeAnalysis ..., https://learn.microsoft.com/en-us/dotnet/api/microsoft.codeanalysis.csharp.syntaxfactory.returnstatement?view=roslyn-dotnet-4.9.0 19. c# - Generating semantic code with roslyn - Stack Overflow, https://stackoverflow.com/questions/27842159/generating-semantic-code-with-roslyn 20. SyntaxFactory.CompilationUnit Method (Microsoft.CodeAnalysis.CSharp), https://learn.microsoft.com/en-us/dotnet/api/microsoft.codeanalysis.csharp.syntaxfactory.compilationunit?view=roslyn-dotnet-4.13.0 21. SyntaxFactory.UsingDirective Method (Microsoft.CodeAnalysis.CSharp), https://learn.microsoft.com/en-us/dotnet/api/microsoft.codeanalysis.csharp.syntaxfactory.usingdirective?view=roslyn-dotnet-4.13.0 22. Compiling a Syntax Tree using Roslyn - Stack Overflow, https://stackoverflow.com/questions/36833988/compiling-a-syntax-tree-using-roslyn 23. How to add a using directive outside a namespace using Roslyn? - Stack Overflow, https://stackoverflow.com/questions/75133666/how-to-add-a-using-directive-outside-a-namespace-using-roslyn 24. .NET Core, Roslyn and Code Generation · Code it Yourself - Carlos Mendible, https://carlos.mendible.com/2017/01/29/net-core-roslyn-and-code-generation/ 25. Compiling C# Code Into Memory and Executing It with Roslyn ..., https://www.tugberkugurlu.com/archive/compiling-c-sharp-code-into-memory-and-executing-it-with-roslyn 26. How to generate initialization of class fields with Roslyn - Stack Overflow, https://stackoverflow.com/questions/34532515/how-to-generate-initialization-of-class-fields-with-roslyn 27. roslyn/docs/wiki/How-To-Write-a-C#-Analyzer-and-Code-Fix.md at main - GitHub, https://github.com/dotnet/roslyn/blob/main/docs/wiki/How-To-Write-a-C%23-Analyzer-and-Code-Fix.md
